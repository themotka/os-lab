 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnGammaStart(/* in */ struct IEcoLab1Events* me, /* in */ long double x) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnGammaNormalize(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double normalized) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Step %d : Normalized x from %.6Lf to %.6Lf\n", pCMe->m_iStep, x, normalized);
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnGammaLanczos(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double result) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Step %d : Lanczos approximation result for x = %.6Lf is %.6Lf\n", pCMe->m_iStep, x, result);
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnGammaComplete(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double result) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Step %d : Gamma calculation completed for x = %.6Lf, result = %.6Lf\n", pCMe->m_iStep, x, result);
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_OnGammaStart,
    CEcoLab1Sink_OnGammaNormalize,
    CEcoLab1Sink_OnGammaLanczos,
    CEcoLab1Sink_OnGammaComplete
};
