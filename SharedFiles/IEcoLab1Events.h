...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t (ECOCALLMETHOD *OnGammaStart)(/* in */ struct IEcoLab1Events* me, /* in */ long double x);
    int16_t (ECOCALLMETHOD *OnGammaNormalize)(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double normalized);
    int16_t (ECOCALLMETHOD *OnGammaLanczos)(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double result);
    int16_t (ECOCALLMETHOD *OnGammaComplete)(/* in */ struct IEcoLab1Events* me, /* in */ long double x, /* in */ long double result);
